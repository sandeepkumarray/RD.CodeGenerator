...
namespace RD.CodeGenerator.Utility
{
    /// <summary>
    ...
    {
        private static bool _isCompanyLoaded;
        public static bool isCompanyLoaded
        {
            get
            {
                return _isCompanyLoaded;
            }
            set
            {
                _isCompanyLoaded = value;
            }
        }

        private static bool _isDealLoaded;
        public static bool isDealLoaded
        {
            get
            {
                return _isDealLoaded;
            }
            set
            {
                _isDealLoaded = value;
        ...
        private static int _DealSearchCount;
        public static int DealSearchCount
        {
            get
            {
                return _DealSearchCount;
            }
            set
            {
                _DealSearchCount = value;
            }
        }
